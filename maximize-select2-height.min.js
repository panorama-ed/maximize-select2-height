...
return s?u=window.innerHeight-o.offset().top-e.scrollTop():(a=t("#select2-"+n+"-container").parent().parent().parent().offset().top,h=r.height()-o.height(),u=a-e.scrollTop()-h),u-i(c,s).cushion}
